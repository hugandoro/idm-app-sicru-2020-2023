...
<div class="row">
	...
	<aside class="col-sm-6">
		<form name="form1" method="post" onSubmit="return revisar(form1);" action="convocatorias_inscribir1.php">
			...
			<div class="form-group">
				<input type="submit" class="btn btn-success btn-block" value=" Avanzar... " /></p>
			</div>
		</form>
	</aside>
